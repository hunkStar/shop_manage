  ...
  <div class="login_container">
    <div class="login_box">
      ...
      >
        ...
        <!-- 验证码  -->
        <el-form-item class="validation" prop="yzm">
          <el-input
...
export default {
  data () {
    var checkYzm = (rule, value, callback) => {
      ...
      } else if (value !== this.verifyData.toLowerCase()) {
  ...
  methods: {
    ...
    login () {
      this.$refs.loginFormRef.validate(async valid => {
        // valid 的值为true/false， true表示表单所有的验证都通过
        if (!valid) {
          return false
        } else {
