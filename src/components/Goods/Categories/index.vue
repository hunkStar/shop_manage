<template>
  <div>
    ...
    <el-card>
      ...
      <tree-table class="treeTable" :data="catelist" :columns="columns" :selection-type="false" :expand-type="false" show-index index-text="#" border >
        ...
        <template slot="opt" slot-scope="scope">
          ...
          <el-button type="danger" icon="el-icon-delete" size="mini" @click="delRoleDialog(scope.row.cat_id)">删除</el-button>
        </template>
      </tree-table>
    ...
    <!-- 修改分类的对话框 -->
    <el-dialog title="修改分类" :visible.sync="editCateDialogVisible" width="40%" @close="editDialogClosed">
